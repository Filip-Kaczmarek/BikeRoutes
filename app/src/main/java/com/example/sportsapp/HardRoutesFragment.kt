...
class HardRoutesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_hard_routes, container, false)

        val recyclerView = rootView.findViewById<RecyclerView>(R.id.hardRoutesList)

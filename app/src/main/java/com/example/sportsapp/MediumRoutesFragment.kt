...
class MediumRoutesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_medium_routes, container, false)

        val recyclerView = rootView.findViewById<RecyclerView>(R.id.mediumRoutesList)

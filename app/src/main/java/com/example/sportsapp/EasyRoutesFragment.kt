...
class EasyRoutesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_easy_routes, container, false)

        val recyclerView = rootView.findViewById<RecyclerView>(R.id.easyRoutesList)
